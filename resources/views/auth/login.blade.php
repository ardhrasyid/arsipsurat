                            ...
                            <div class="card card-plain bg-white">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        @method('post')
                                        <div class="mb-3">
                                            <input type="email" name="email" class="form-control form-control-lg" value="Rasyid@gmail.com" aria-label="Email">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Aplikasi Pengarsipan Surat Resmi Desa Karangduren</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form" method="POST" action="{{ route('login.perform') }}">
                                ...
                                @method('post')
                                <div class="mb-3">
                                    <input type="email" name="email" class="form-control form-control-lg" value="{{ old('email') ?? 'rasyid@gmail.com'}}" aria-label="Email" placeholder="Email">
                                    @error('email') <p class="text-danger text-xs pt-1"> {{$message}} </p>@enderror
                                </div>
                                <div class="mb-3">
